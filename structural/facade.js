// Служит для создания упрощенного интерфейса для взаимодействия с классами
...
console.log(registry.register('Bill', 'service', 'недоступен'));
console.log(registry.register('Mike', 'products', 'ошибка'));